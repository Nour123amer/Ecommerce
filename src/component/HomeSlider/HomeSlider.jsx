...
<div className='grid grid-cols-12 mb-6'>
  ...
  <swiper-slide> 
     <img src={image1} className='w-full  h-full object-cover' alt="" /></swiper-slide>
  </swiper-container>
 
    </div>
    <div className='col-span-4 bg-lime-300'>
        <div className="h-1/2"> <img  src={image2} className='w-full  h-full object-cover ' alt="" /></div>
   

    <div className="h-1/2"> <img  src={image1} className='w-full  h-full object-cover' alt="" /></div>
